...
exports.getAll = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json({ status: true, data: result, message: "Success" });
  } catch (error) {
  ...
  try {
    ...
    return res
      ...
      .json({
        status: true,
        data: result,
        message: "Outgoing Mail created successfully",
      });
  } catch (err) {
    console.log(err);
...
exports.update = async (req, res) => {
  try {
    ...
    return res
      ...
      .json({
        status: true,
        message: "Outgoing Mail updated successfully",
        data: result,
      });
  } catch (err) {
    return res.status(400).json({ status: false, message: err.message });
...
exports.delete = async (req, res) => {
  try {
    ...
    return res
      ...
      .json({
        status: true,
        message: "Outgoing Mail deleted successfully",
        data: null,
      });
  } catch (error) {
