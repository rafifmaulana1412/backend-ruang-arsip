...
exports.create = async (req, res) => {
    try {
        ...
        return res.status(201).json({ status: true, data: result, message: "Document created successfully" });
    } catch (err) {
...
exports.delete = async (req, res) => {
    try {
        ...
        return res.status(200).json({ status: true, message: "Document deleted successfully", data: null });
    } catch (error) {
